...
**Topics covered:**
- How to publish marine-focused datasets to GBIF and OBIS simultaneously
...
| Is there a plan to make GBIF/OBIS streamline together? | Yes. OBIS and GBIF have endorsed a joint strategy and action plan for marine biodiversity data. See: [OBIS and GBIF endorse joint strategy and action plan for marine biodiversity data](https://www.gbif.org/news/7w0xoodpNZRwnt1SjWfML0/obis-and-gbif-endorse-joint-strategy-and-action-plan-for-marine-biodiversity-data) |
...
| Is there a plan to one day include prokaryotes? | That day is today 😀. As long as you can assign your prokaryote to a kingdom it can be shared as such in OBIS. WoRMS doesn't have a domain level of classification, but they are aware of the challenges this can create with DNA data. |
